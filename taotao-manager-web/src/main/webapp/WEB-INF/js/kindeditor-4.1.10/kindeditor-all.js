...
SWFUpload.prototype.destroy = function () {
	try {
		...
		if (movieElement && typeof(movieElement.CallFunction) === "unknown") { // We only want to do this in IE
			// Loop through all the movie's resource and remove all function references (DOM/JS IE 6/7 memory leak workaround)
...
// resource that contain characters that are not valid for JavaScript identifiers. To work around this
