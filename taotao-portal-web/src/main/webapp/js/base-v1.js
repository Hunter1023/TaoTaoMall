...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function () {
    ...
    var a, b = navigator.userAgent.toLowerCase(), c = document.referrer, d = /ipad/,
        e = /mobile|ios|iphone|android|windows phone|uc|mqqbrowser/, f = readCookie("goToMobile"),
        g = document.getElementById("shortcut-2013"), h = document.createElement("div");
